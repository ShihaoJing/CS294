...
def main():
    ...
    print("teacher rollouts: ")
    generate_rollouts(env, teacher, max_steps, args.num_rollouts, args.render, args.verbose)
    print("student rollouts: ")
